...
class ModeloInformacion
{
	...
	static public function mdlEditarInformacion($tabla, $datos)
	{
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET  nombre = :nombre, mision = :mision, vision = :vision, quienes_somos = :quienes_somos, correo= :correo WHERE id = :id");
	...
	static public function mdlEditarInformacionImg($tabla, $datos)
	{
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET  nombre = :nombre, mision = :mision, vision = :vision, quienes_somos = :quienes_somos, correo= :correo, logo= :logo WHERE id = :id");
