...
class Terrenos{
	...
	static public function mdlEditarTerreno($tabla,$datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET id_beneficiario = :id_beneficiario,
		perimetro = :perimetro, area = :area, adaptabilidad = :adaptabilidad,tipo_terreno = :tipo_terreno,
		tipo_suelo = :tipo_suelo,porcentaje_agua = :porcentaje_agua,
		porcentaje_minerales = :porcentaje_minerales WHERE id = :id");
