...
<div class="content-wrapper" style="background-color:#FFFFFF;  position:relative; width:1170px; left:200px">
  ...
  <section class="content-header" style="background-color:#FFFFFF">
    ...
    <ol class="breadcrumb" style="background-color:#FFFFFF">
      ...
      <li><a href="inicio" style="background-color:#FFFFFF;color:black"><i class="fa fa-dashboard"></i> Inicio</a></li>
            ...
            foreach ($terrenos as $key => $value) {
              ...
              $terrenos = TerrenosController::ctrMostrarTerrenos($item, $valor);
                ...
                echo ' <tr style="width:10px; background-color:white; color:black; border: 2px white solid;">
                        <td class="text-uppercase" style="width:10px; background-color:white; color:black; border: 2px white solid;">' . ($key+1). '</td>
