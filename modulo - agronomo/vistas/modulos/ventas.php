...
<div class="content-wrapper" style="background-color:#FFFFFF; position:relative; width:1170px; left:200px">
  ...
  <section class="content-header" style="background-color:#FFFFFF">
    ...
    <h1 style="color:#330470; font-family: monospace; font-weight: bold;">
    ...
    <div class="box" style="background-color:#FFFFFF; border: 2px white solid;">
      ...
      <div class="box-header with-border" style="background-color:#FFFFFF; border: 2px white solid;">
        ...
        <a href="crear-venta">
          ...
          <button class="btn btn-primary" style="background-color:#FF5822; color:white; border: 2px #FF5822 solid;">
        ...
        <table class="table table-bordered table-striped dt-responsive tablas" width="100%" style="background-color:white; color:black; border: 2px white solid;">
          ...
          <thead>
            ...
            <tr>
              ...
              <th>Código </th>
              <th>Beneficiario</th>
              <th>Administrador o agrónomo</th>
            ...
            foreach ($respuesta as $key => $value) {
              ...
              echo '<td>' . $respuestaUsuario["nombre"] . '</td>
                  ...
                  <td>
                    ...
                    <button style="background-color:#330470;width:35px; height:34px">
                    <i class="fa fa-print" style="color: white;"><input style="width:20px;color: white;background-color:#330470;border-color:white;border:none" type="button" value="" class="printbutton"></i>  
                  </button>';
