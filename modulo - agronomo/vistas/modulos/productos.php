          ...
          <div class="box-body" style="background:white; color:black; border: 2px white solid;">
            ...
            <div class="form-group" style="background:white; color:white">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon" style="background:#02016D; color:#FF0074; border: 2px transparent solid;"><i class="fa fa-th"></i></span> 
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon" style="background:#02016D; color:#FF0074; border: 2px transparent solid;"><i class="fa fa-code"></i></span> 

                <input type="text" class="form-control input-lg" id="editarCodigo" name="editarCodigo" style="background:white; color:#FF0074; border-top: 2px #FF0074 solid; border-bottom: 2px #FF0074 solid;border-right: 2px #FF0074 solid;" readonly required>
            ...
            <!-- ENTRADA PARA LA DESCRIPCIÓN -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon" style="background:#02016D; color:#FF0074; border: 2px transparent solid;"><i class="fa fa-product-hunt"></i></span> 
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon" style="background:#02016D; color:#FF0074; border: 2px transparent solid;"><i class="fa fa-check"></i></span> 
             ...
             <div class="form-group row">
                ...
                <div class="col-xs-6">
                  ...
                  <div class="input-group">
                    ...
                    <span class="input-group-addon" style="background:#02016D; color:#FF0074; border: 2px transparent solid;"><i class="fa fa-arrow-up"></i></span> 
                ...
                <div class="col-xs-6">
                  ...
                  <div class="input-group">
                    ...
                    <span class="input-group-addon" style="background:#02016D; color:#FF0074; border: 2px transparent solid;"><i class="fa fa-arrow-down"></i></span> 
                  ...
                  <div class="col-xs-6" style="padding:0">
                    ...
                    <div class="input-group">
                      ...
                      <span class="input-group-addon" style="background:#02016D; color:#FF0074; border: 2px transparent solid;"><i class="fa fa-percent"></i></span>
