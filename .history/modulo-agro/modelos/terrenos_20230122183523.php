...
class Terrenos{
	...
	static public function mdlMostrarTerrenos($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT SELECT clientes.nombre as beneficiario, terrenos.perimetro,terrenos.area,terrenos.adaptabilidad,terrenos.tipo_terreno,terrenos.tipo_suelo,terrenos.porcentaje_agua,
