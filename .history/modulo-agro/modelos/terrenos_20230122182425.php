...
class Terrenos{
	...
	static public function mdlMostrarTerrenos($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT clientes.nombre, terrenos.perimetro,terrenos.area,terrenos.adaptabilidad,terrenos.tipo_terreno,terrenos.tipo_suelo,terrenos.porcentaje_agua,terrenos.porcentaje_minerales  FROM terrenos, clientes WHERE terrenos.id_beneficiario= clientes.id");
