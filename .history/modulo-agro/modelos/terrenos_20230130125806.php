...
class Terrenos{
	...
	static public function mdlMostrarTerrenos($item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT * FROM terrenos");
	...
	static public function mdlEditarTerreno($datos){

		$stmt = Conexion::conectar()->prepare("UPDATE terrenos SET id_beneficiario = :id_beneficiario,perimetro = :perimetro, area = :area, adaptabilidad = :adaptabilidad,tipo_terreno = :tipo_terreno,tipo_suelo = :tipo_suelo,porcentaje_agua = :porcentaje_agua,porcentaje_minerales = :porcentaje_minerales WHERE id = :id");
	...
	static public function mdlBorrarTerreno($tabla, $datos){
