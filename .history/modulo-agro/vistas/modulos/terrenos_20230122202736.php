            ...
            echo ' <tr style="width:10px; background-color:white; color:black; border: 2px white solid;">
                    ...
                    <td style="width:10px; background-color:white; color:black; border: 2px white solid;">
                      ...
                      <div class="btn-group" >
                        ...
                        <button class="btn btn-warning btnEditarTerreno" style="background:#63FC00; color:black; border: 2px #63FC00 solid;" id="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarTerreno"><i class="fa fa-pencil"></i></button>';
          ...
          <div class="box-body" style="background:white; color:white; border: 2px white solid;">
            ...
            <div class="form-group" style="background:white; color:white">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg"  style="background:black; color:white" name="editarBeneficiario" readonly required>
                  
                  <option id="editarBeneficiario"  style="background:black; color:white"></option>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="editarPerimetro" name="editarPerimetro" style="background:black; color:white" readonly required>
            ...
            <!-- ENTRADA PARA EL AREA -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" id="editarAdaptabilidad" name="editarAdaptabilidad" min="0" required>
             ...
             <div class="form-group row">
                ...
                <div class="col-xs-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control input-lg" id="editarTipo_terreno" name="editarTipo_terreno" step="any" min="0" required>
                ...
                <div class="col-xs-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control input-lg" id="editarTipo_suelo" name="editarTipo_suelo" step="any" min="0" style="background:black; color:white" readonly required>
