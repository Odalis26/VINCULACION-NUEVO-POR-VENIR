  ...
  <section class="content" style="background-color:#FFFFFF">
    ...
    <div class="box" style="background-color:#FFFFFF; border: 2px white solid;">
      ...
      <div class="box-body" style="background-color:white; color:black; border: 2px white solid;">
        ...
        <table class="tablas" width="100%" style="background-color:white; color:black; border: 2px white solid;">
          ...
          <tbody>
            ...
            foreach ($terrenos as $key => $value) {
              ...
              echo ' <tr style="width:10px; background-color:white; color:black; border: 2px white solid;">
                    ...
                    <td class="text-uppercase" style="width:10px; background-color:white; color:black; border: 2px white solid;">' . $value["id_beneficiario.nombre"] . '</td>
          ...
          <div class="box-body" style="background:white; color:white; border: 2px white solid;">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" id="editarBeneficiario" name="editarBeneficiario" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarTipo_terreno" id="editarTipo_terreno"required>
                <input type="text" class="form-control input-lg" name="editarTipo_suelo" id="editarTipo_suelo" required>
                <input type="text" class="form-control input-lg" name="editarPorcentaje_agua" id="editarPorcentaje_agua" required>
                <input type="text" class="form-control input-lg" name="editarPorcentaje_minerales" id="editarPorcentaje_minerales" required>
              </div>
...
$eliminarTerreno = new TerrenosController();
$eliminarTerreno -> ctrBorrarTerreno();
