...
<div class="content-wrapper"  style="background-color:#FFFFFF">
  ...
  <section class="content-header"  style="background-color:#FFFFFF">
    ...
    <ol class="breadcrumb" style="background-color:#5F9EA0;">
      
      <li><a href="inicio" style="background-color:#5F9EA0;">Inicio</a></li>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-footer" style="background-color:white; color:black; border: 2px white solid;">
          ...
          <button type="submit" class="btn btn-primary" style="background:#4CEB02; color:black; border: 2px #4CEB02 solid;">Guardar cambios</button>
