          ...
          $clientes = ControladorClientes::ctrMostrarClientes($item, $valor);
           ...
           $clientes = ControladorClientes::ctrMostrarClientes($item, $valor);
            ...
            echo ' <tr style="width:10px; background-color:white; color:black; border: 2px white solid;">
                    ...
                    <td class="text-uppercase" style="width:10px; background-color:white; color:black; border: 2px white solid;">'.$value1["nombre"].'</td> ';
           }  
                    foreach ($terrenos as $key => $value) {
                      $terrenos = TerrenosController::ctrMostrarTerrenos($item, $valor);
                   echo' <td class="text-uppercase" style="width:10px; background-color:white; color:black; border: 2px white solid;">'.$value["perimetro"].'</td>
