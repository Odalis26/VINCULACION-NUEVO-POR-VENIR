          ...
          <div class="box-body" style="background:white; color:white; border: 2px white solid;">
           ...
           <div class="input-group">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" min="0" class="form-control input-lg" name="editarArea" id="editarArea" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarTipo_terreno" id="editarTipo_terreno">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarPorcentaje_agua" id="editarPorcentaje_agua">
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarPorcentaje_minerales" id="editarPorcentaje_minerales">
