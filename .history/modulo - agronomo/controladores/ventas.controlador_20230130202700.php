...
class ControladorVentas{
	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			/*=============================================
			ACTUALIZAR LAS DONACIONES DEL BENEFICIARIO Y REDUCIR EL STOCK Y AUMENTAR LAS DONACIONES DE LOS PRODUCTOS
			=============================================*/
	...
	static public function ctrEditarVenta(){
		...
		if(isset($_POST["editarVenta"])){
			...
			/*=============================================
			FORMATEAR TABLA DE PRODUCTOS Y LA DE BENEFICIARIOS
			=============================================*/
			$tabla = "ventas";
			...
			if($cambioProducto){
				...
				/*=============================================
				ACTUALIZAR LAS COMPRAS DEL BENEFICIARIO Y REDUCIR EL STOCK Y AUMENTAR LAS DONACIONES DE LOS PRODUCTOS
				=============================================*/
	...
	static public function ctrEliminarVenta(){
		...
		if(isset($_GET["idVenta"])){
			...
			/*=============================================
			ACTUALIZAR FECHA ÚLTIMA DONACIÓN
			=============================================*/
	...
	public function ctrDescargarReporte(){
		...
		if(isset($_GET["reporte"])){
			...
			echo utf8_decode("<table border='0'> 
					...
					<td style='font-weight:bold; border:1px solid #eee;'>ADMINISTRADOR DE DONACIONES</td>
					<td style='font-weight:bold; border:1px solid #eee;'>CANTIDAD</td>
					<td style='font-weight:bold; border:1px solid #eee;'>PRODUCTOS DONADOS</td>
					<td style='font-weight:bold; border:1px solid #eee;'>IMPUESTO</td>
					<td style='font-weight:bold; border:1px solid #eee;'>PUNTUACIÓN DE ENTRADA</td>		
					<td style='font-weight:bold; border:1px solid #eee;'>PUNTUACIÓN DE SALIDA</td>		
					<td style='font-weight:bold; border:1px solid #eee;'>MÉTODOS DE DONACIÓN A LA FUNDACIÓN</td	
